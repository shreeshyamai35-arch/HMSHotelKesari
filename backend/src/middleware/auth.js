...
function authenticate(req, _res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var header, token, user, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    header = req.headers.authorization;
                    if (!header || !header.startsWith('Bearer ')) {
                        return [2 /*return*/, next((0, errors_1.unauthorized)('Missing or invalid Authorization header'))];
                    }
                ...
                case 2:
                    user = _b.sent();
                    if (!user || !user.active) {
                        return [2 /*return*/, next((0, errors_1.unauthorized)('Account deactivated'))];
                    }
                    next();
                    return [3 /*break*/, 4];
                case 3:
